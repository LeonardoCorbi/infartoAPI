...
class ArticleSearchSingleController {
    ...
    indexAlimentacao(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const requiredId = Number(request.params.id);
    ...
    indexExercicio(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const requiredId = Number(request.params.id);
    ...
    indexTratamento(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const requiredId = Number(request.params.id);
...
exports.default = ArticleSearchSingleController;
